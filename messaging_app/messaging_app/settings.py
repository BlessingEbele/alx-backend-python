...
SECRET_KEY = 'django-insecure-obmn_jog^-807mt!uda^#_)s16#rzb4i7k7^oy^0g*)ihac0-8'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'db',  # This MUST match the name of the db service in docker-compose.yml
        'PORT': '5432',
    }
}
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # add TokenAuthentication or JWT later for APIs
    ],
